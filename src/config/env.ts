export const PACKAGE_ID = import.meta.env.VITE_PACKAGE_ID || "0xb1aa5cf72d7c9e7e237c2ddcd785ceb7aacbef4229ee712ec05f9afb188b0ab9";
export const MODULE_NAME = import.meta.env.VITE_MODULE_NAME || "degreensci";
export const NFT_REGISTRY = import.meta.env.VITE_NFT_REGISTRY || "";
